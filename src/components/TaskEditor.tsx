...
import type { Task, Priority, Effort, ExtraTaskDraft, RecurrenceType, ChainItem, DeliverableKind, TimeOfDay, ReminderKind, Polarity } from '../types';
...
export function TaskEditor({ visible, task, initialDraft, onClose }: Props) {
  ...
  useEffect(() => {
    ...
    initialStateRef.current = JSON.stringify({
      ...
      supplyReorderAt: task ? (task.supplyReorderAt ?? DEFAULT_SUPPLY_REORDER_AT) : DEFAULT_SUPPLY_REORDER_AT,
