...
describe('taskKindOf agrees with the readers that act on the fields', () => {
  const shape = (over: Record<string, unknown> = {}) => ({
    ...
    healthMetric: null, healthTarget: null, completionTimerMinutes: null, completionTimerNote: null, completionTimerStartedAt: null, logHealthMetric: null, logHealthAmount: null, medicationName: null, medicationAmount: null, medicationUnit: null, logMealSlot: null, ...over,
