...
export const TIPS: Tip[] = [
  ...
  },
  {
    ...
    body: 'A task can be blocked by another task, or by a person you are waiting to hear from. Blocked tasks stay out of your way and collect on the Stuck screen.',
    link: { label: 'Open Stuck', screen: 'Stuck' },
  ...
  },
  {
    ...
    body: 'Two items can be linked as a choice, so the list asks for one of them rather than both. Buying either one takes the other off the list.',
  ...
  },
  {
    ...
    body: 'Moving an item to the freezer pauses its use-by date, and taking it out again starts it running from where it left off. Nothing in the freezer is counted as going off.',
    when: s => s.purchasedItemCount >= 5,
  ...
  // ==== Around the app ====
  {
    ...
    body: 'Settings has a search field at the top that finds a row by name or by what it does, and jumps straight to it. Faster than remembering which group it is in.',
    link: { label: 'Open Settings', screen: 'Settings' },
  ...
  },
  {
    ...
    body: 'The Stuck screen collects anything you have rescheduled over and over. A task pushed nine times is usually one to reword, break up, or drop.',
    link: { label: 'Open Stuck', screen: 'Stuck' },
    when: s => s.completedCount >= 30,
