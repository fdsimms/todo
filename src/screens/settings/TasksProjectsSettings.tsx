        ...
        {mealCookTasks && (
          <>
            ...
            <SettingsRow
              ...
              value={newTaskCategoryOptions.find(o => o.value === mealCookTaskCategory)?.label ?? 'None'}
              tight
            />
            <View style={styles.pillGroupRow}>
              <PillGroup
                ...
                options={categoryPills(
                  ...
                  setMealCookTaskCategory,
                  label => `Cook task category: ${label}`,
                )}
              />
            </View>
          </>
        ...
        {groceryUseUpTasks && (
          <>
            ...
            <SettingsRow
              ...
              hint="With none, they sit loose at the top of Today above your categories"
              value={newTaskCategoryOptions.find(o => o.value === groceryUseUpTaskCategory)?.label ?? 'None'}
              tight
            />
            <View style={styles.pillGroupRow}>
              <PillGroup
                ...
                options={categoryPills(
                  ...
                  setGroceryUseUpTaskCategory,
                  label => `Use-up task category: ${label}`,
                )}
              />
            </View>
          </>
        ...
        {leftoverUseUpTasks && (
          <>
            ...
            <SettingsRow
              ...
              label="File use-up tasks under"
              hint="With none, they sit loose at the top of Today above your categories"
              value={newTaskCategoryOptions.find(o => o.value === leftoverUseUpTaskCategory)?.label ?? 'None'}
              tight
            />
            <View style={styles.pillGroupRow}>
              <PillGroup
                ...
                options={categoryPills(
                  ...
                  setLeftoverUseUpTaskCategory,
                  label => `Leftover use-up task category: ${label}`,
                )}
              />
            </View>
          </>
