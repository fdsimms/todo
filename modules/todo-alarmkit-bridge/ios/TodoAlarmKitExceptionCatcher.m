#import "TodoAlarmKitExceptionCatcher.h"

@implementation TodoAlarmKitExceptionCatcher
...
+ (void)runCatchingExceptions:(void (^)(void))block
{
  ...
  @catch (NSException *exception) {
    ...
    // expo/expo#44680. A failed alarm schedule/cancel should never be able
    // to take down the whole app.
    NSLog(@"[TodoAlarmKitBridge] Caught NSException: %@", exception);
  }
}
