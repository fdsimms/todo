...
- `src/utils/labelOcr.ts` — LabelReading, readNutritionLabel, readLabelPhoto
...
- `src/utils/nutritionPanelForm.ts` — PanelForm, PanelFieldKey, emptyPanelForm, panelFormFrom, readPanelNumber, invalidPanelFields, panelFormDirty, buildPanelNutrition, applyLabelReading, labelReadingFieldCount
