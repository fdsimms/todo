...
`store/useTaskStore.ts` (8.6k), `db/database.ts` (5.8k), `components/TaskEditor.tsx` (5.8k),
...
The suite is **309 test files**, and `npm test` runs all of them in about half a minute.
