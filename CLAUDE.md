...
`store/useTaskStore.ts` (6.6k), `components/TaskEditor.tsx` (4.7k), `db/database.ts` (4.3k),
...
The suite is **219 test files**, and `npm test` runs all of them in about half a minute.
