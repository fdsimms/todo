...
`store/useGroceryStore.ts` (4.7k), `screens/TodayScreen.tsx` (4.3k), `types/index.ts` (4.1k),
...
The suite is **237 test files**, and `npm test` runs all of them in about half a minute.
