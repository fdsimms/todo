...
`types/index.ts` (4.9k), `store/useGroceryStore.ts` (4.9k), `screens/TodayScreen.tsx` (4.6k),
...
The suite is **275 test files**, and `npm test` runs all of them in about half a minute.
