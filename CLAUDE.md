...
`store/useGroceryStore.ts` (4.0k), `db/database.ts` (3.9k), `screens/TodayScreen.tsx` (3.8k),
...
The suite is **182 test files**, and `npm test` runs all of them in about half a minute.
