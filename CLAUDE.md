...
`store/useGroceryStore.ts` (4.8k), `types/index.ts` (4.8k), `screens/TodayScreen.tsx` (4.6k),
...
The suite is **272 test files**, and `npm test` runs all of them in about half a minute.
