...
`screens/TodayScreen.tsx` (4.1k), `store/useGroceryStore.ts` (4.1k), `types/index.ts` (3.7k),
...
The suite is **210 test files**, and `npm test` runs all of them in about half a minute.
