...
`store/useTaskStore.ts` (6.1k), `components/TaskEditor.tsx` (4.6k), `db/database.ts` (4.2k),
`store/useGroceryStore.ts` (4.1k), `screens/TodayScreen.tsx` (4.0k), `types/index.ts` (3.5k),
`components/TaskItem.tsx` (3.5k), `components/QuickAddModal.tsx` (2.8k),
`store/useSettingsStore.ts` (2.6k), `utils/demoSeed.ts` (2.3k).
