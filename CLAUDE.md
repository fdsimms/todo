...
`store/useTaskStore.ts` (7.6k), `components/TaskEditor.tsx` (5.9k), `db/database.ts` (5.8k),
...
The suite is **323 test files**, and `npm test` runs all of them in well under a minute.
